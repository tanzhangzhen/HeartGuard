...
@interface RetrievePwd1ViewController ()
{
    UIView *bgView;
    UITextField *phone;
    UITextField *code;
...
@implementation RetrievePwd1ViewController
...
- (void)viewDidLoad {
    ...
    backBtn.tintColor=[UIColor whiteColor];//返回箭头颜色
...
//    label.textAlignment=UITextAlignmentLeft;
    ...
    phonelabel.textAlignment = UITextAutocapitalizationTypeAllCharacters;
...
-(void)landClick
{
    ...
    RetrievePwd2ViewController *new=[[RetrievePwd2ViewController alloc]init];
    //赋值
